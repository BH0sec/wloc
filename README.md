...
>
> **兼容性提示：本项目仅适用于 iOS 27 之前的系统。** 由于 iOS 27 对
> `locationd` / Location 相关链路加入了更强的认证与校验，目前已无法继续通过本项目
> 拦截并修改 Apple WLOC 响应来改变系统定位。iOS 27 及更新系统请不要预期本方法生效。
...
- 仅适用于 iOS 27 之前的系统；iOS 27 及更新系统目前无法使用本方法修改定位。
- iOS 26 及之前的高版本系统缓存定位结果更积极，切换坐标后可能需要重启设备才会重新请求 WLOC。
